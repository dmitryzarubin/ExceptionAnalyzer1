...
namespace Advitex.ExceptionAnalizer.Resharper.Highlightings
{
    ...
    public class PossibleNotDocumentedArgumentNullExceptionHighlighting : CSharpHighlightingBase, IHighlighting
    {
        public PossibleNotDocumentedArgumentNullExceptionHighlighting([NotNull] ThrownException exception)
        {
            if (exception == null)
            ...
            ToolTip = string.Format("Perhaps, exception of type {0} is not documented [Exception Analyzer]",
                                    Exception.ShortTypeName);
        }

        public const string SeverityId = "PossibleNotDocumentedExceptionHighlighting.ArgumentNullException";
        ...
        {
            return !WeakDocumentedExceptionSpecification.IsSpecified(Exception) ||
