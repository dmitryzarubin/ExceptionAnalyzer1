...
namespace Advitex.ExceptionAnalizer.Resharper.Highlightings
{
    ...
    public class PossibleNotDocumentedExceptionHighlighting : CSharpHighlightingBase, IHighlighting
    {
        public PossibleNotDocumentedExceptionHighlighting([NotNull] ThrownException exception)
        {
            if (exception == null)
        ...
        public const string SeverityId = "PossibleNotDocumentedExceptionHighlighting";
