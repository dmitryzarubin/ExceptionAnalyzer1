...
{
    [QuickFix]
    public class AddThrowStatementIntoDocumentationFix : QuickFixBase
    {
        public AddThrowStatementIntoDocumentationFix([NotNull] NotDocumentedThrowHighlighting highlighting)
        {
        ...
        public AddThrowStatementIntoDocumentationFix([NotNull] PossibleNotDocumentedThrowHighlighting highlighting)
        {
            if (highlighting == null)
                throw new ArgumentNullException("highlighting");
        ...
        public override string Text
        {
            get
            {
                return string.Format("Add exception of type {0} to xml documentation [Exception Analyzer]",
                                     _exception.ShortTypeName);
            }
        }
